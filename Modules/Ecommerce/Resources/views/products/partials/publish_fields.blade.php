...
<div class="box box-solid">
    <div class="box-header with-border">
        <h3 class="box-title">E-commerce storefront</h3>
    </div>
    <div class="box-body">
        @if(empty($store) || empty($store->id))
            <div class="alert alert-info">
                Configure your storefront first in <strong>E-commerce &gt; Store settings</strong> before publishing products online.
            </div>
        @else
            <div class="row">
                <div class="col-sm-3">
