...
<section class="content no-print">
    <div class="row">
        <div class="col-md-12">
            ...
            => 'get', 'id' => 'product_sell_report_form' ]) !!}
            <div class="col-md-3">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    {!! Form::select('psr_customer_group_id', $customer_group, null, ['class' => 'form-control select2',
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    {!! Form::select('category_id', $categories, null, ['class' => 'form-control select2', 'style' =>
            ...
            <div class="col-md-3">
                ...
                @php
                $startDay ='00:00:00';// Carbon::now()->startOfDay();
                $endDay = '23:59:59';// $startDay->copy()->endOfDay();
                @endphp
                <div class="form-group">
                    {!! Form::text('start_time', @format_time($startDay), ['style' => __('lang_v1.select_a_date_range'),
                    'class' => 'form-control width-50 f-left', 'id' => 'product_sr_start_time']); !!}
                    {!! Form::text('end_time', @format_time($endDay), ['class' => 'form-control width-50 f-left', 'id'
                    => 'product_sr_end_time']); !!}
                </div>
            </div>
            {!! Form::close() !!}
