...
<div class="row">
    <div class="row">
        <div class="col-xs-6">
            ...
            <img style="max-height: 80px; width: auto;" src="{{$receipt_details->letter_head}}"
        ...
        <table class="table customer-info-table" style="width: 98%; font-size: 12px;">
            <tbody>
                <tr style="background: #2d2360;">
                    ...
                    <td
                        style="padding: 5px; font-weight: bold; width: 15%;  direction: rtl; text-align: left !important;">
                        رقم العميل:</td>
                    <td style="padding: 5px; font-weight: bold; width: 20%;text-align: right !important;">INVOICE
                        TIMESTAMP:</td>
                    <td class="print-red" style="padding: 5px; width: 18%;">{{$receipt_details->invoice_date}}</td>
                    <td
                        style="padding: 5px; font-weight: bold; width: 20%;  direction: rtl; text-align: left !important;">
                        وقت الفاتورة:</td>
                </tr>
                <tr style="background: #2d2360;">
                    ...
                    <td style="padding: 5px; font-weight: bold;  direction: rtl; text-align: left !important;">اسم
                        العميل:</td>
                    ...
                    <td style="padding: 5px; font-weight: bold;  direction: rtl; text-align: left !important;">تاريخ
                        الاستحقاق:</td>
                </tr>
                <tr style="background: #2d2360;">
                    ...
                    <td
                        style="padding: 5px; font-weight: bold;  direction: rtl; text-align: right; text-align: left !important;">
                        سجل العميل:</td>
                    <td style="padding: 5px; font-weight: bold;text-align: right !important;">SALES ORDER ID:</td>
                    <td style="padding: 5px;">
                        <!-- now empty -->
                    </td>
                    <td style="padding: 5px; font-weight: bold;  direction: rtl; text-align: left !important;">رقم طلب
                        البيع:</td>
                </tr>
                <tr style="background: #2d2360;">
                    ...
                    <td style="padding: 5px; font-weight: bold;  direction: rtl; text-align: left !important;">الرقم
                        الضريبي:</td>
                ...
                <tr style="background: #2d2360;">
                    ...
                    <td style="padding: 5px; font-weight: bold;  direction: rtl; text-align: left !important;">عنوان
                        العميل:</td>
                </tr>
            </tbody>
        </table>
                    ...
                    <div style="font-size: 12px;">
                        ...
                        <div>
                            ...
                            <span>
                                ...
                                {{
                                app(\App\Utils\TransactionUtil::class)->numberToCurrencyWords($receipt_details->total_unformatted,
                                'riyal', 'halala', 'fr') }}
                                @endif
                            </span>
                            <br>
                        ...
                        <table class="table table-bordered" style="width: 98%; font-size: 11px; margin-bottom: 2px;">
                            <tbody>
                                <tr>
                                    ...
                                    <td style="font-weight: bold; direction: rtl; text-align: right; width: 45%;">المبلغ
                                        الكلي:</td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="print-red" style="text-align: center;">
                                        @format_currency($receipt_details->subtotal_unformatted -
                                        $receipt_details->discount_amount_unformatted)
                                    </td>
                                    <td style="font-weight: bold; direction: rtl; text-align: right;">المبلغ بعد الخصم:
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td style="font-weight: bold; direction: rtl; text-align: right;">إجمالي ضريبة
                                        القيمة المضافة:</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td style=" font-weight: bold; direction: rtl; text-align: right;">المبلغ المدفوع:
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td style="font-weight: bold; direction: rtl; text-align: right;">المبلغ المستحق:
                                    </td>
                                </tr>
...
<div class="row avoid-page-break">
    ...
    <div class="col-xs-3 text-center">
        ...
        <img class="center-block" style="margin: 0 auto; width: 180px; height: 180px;"
            src="data:image/png;base64,{{DNS2D::getBarcodePNG($receipt_details->qr_code_text, 'QRCODE', 4, 4)}}"
            alt="QR Code">
        @endif
    </div>
</div>
