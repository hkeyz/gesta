        ...
        <div
            ...
            <div class="!tw-w-full md:!tw-w-none !tw-flex md:!tw-hidden !tw-flex-row !tw-items-center !tw-gap-3">
                ...
                <button type="button"
                    ...
                    id="pos-finalize" title="@lang('lang_v1.tooltip_checkout_multi_pay')"><i
                        class="fas fa-money-check-alt" aria-hidden="true"></i> @lang('lang_v1.checkout_multi_pay')
                </button>
                @endif
                ...
                @else
                <button type="button" class="btn-danger tw-dw-btn hide tw-dw-btn-xs" id="pos-delete" @if
                    (!empty($only_payment)) disabled @endif> <i class="fas fa-trash-alt"></i>
            ...
            <div class="tw-flex tw-items-center tw-gap-4 tw-flex-row tw-overflow-x-auto">
                ...
                <button type="button"
                    ...
                    data-pay_method="suspend" title="@lang('lang_v1.tooltip_suspend')" @if (!empty($only_payment))
                    disabled @endif>
                ...
                <button type="button"
                    ...
                    data-pay_method="credit_sale" title="@lang('lang_v1.tooltip_credit_sale')" @if
                    (!empty($only_payment)) disabled @endif>
                ...
                <button type="button"
                    ...
                    <i class="fas fa-credit-card tw-text-[#D61B60]" aria-hidden="true"></i>
                ...
                <button type="button"
                    ...
                    id="pos-delete" @if (!empty($only_payment)) disabled @endif> <i class="fas fa-trash-alt"></i>
                    @lang('messages.delete')</button>
                @endif
