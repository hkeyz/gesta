	...
	<div class="col-md-12">
		<table class="table table-condensed">
			...
			<tr>
				...
				<td @if(!Gate::check('disable_discount') || auth()->user()->can('superadmin') ||
					auth()->user()->can('admin')) class="" @else class="hide" @endif>
				...
				<td class="@if($pos_settings['disable_order_tax'] != 0) hide @endif">
					<span class="tw-text-base md:tw-text-lg tw-font-semibold">
						<b class="tw-text-base md:tw-text-lg tw-font-bold">@lang('sale.order_tax')(+):
							@show_tooltip(__('tooltip.sale_tax'))</b>
				...
				<td>
					<span class="tw-text-base md:tw-text-lg tw-font-semibold">
						...
						<b class="tw-text-base md:tw-text-lg tw-font-bold">@lang('sale.shipping')(+):
							@show_tooltip(__('tooltip.shipping'))</b>
				...
				<td>
					<b class="tw-text-base md:tw-text-lg tw-font-bold" id="round_off">@lang('lang_v1.round_off'):</b>
