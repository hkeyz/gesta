...
@section('css')
    ...
    <style type="text/css">
        ...
        /* Category/Brand inner grid cards inside drawers */
        ...
        /* Full product name without layout overlapping */
        ...
        /* If stock count is 0 or less, color it bordeaux/red */
...
@section('javascript')
    ...
    <script>
        window.addEventListener('load', () => {
            setTimeout(() => {
                const logDiv = document.getElementById('pos-debug-log');
                let log = '';
