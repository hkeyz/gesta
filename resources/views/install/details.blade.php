    ...
    <div class="col-md-8 col-md-offset-2">
      ...
      <div class="box box-primary active">
        ...
        <div class="box-body">
          ...
          <form class="form" id="details_form" method="post" action="{{route('install.postDetails')}}">
            {{ csrf_field() }}
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" name="APP_TITLE" class="form-control" id="app_title" value="{{ old('APP_TITLE') }}">
              </div>
            </div>

            <h4> License Details <small class="text-danger">Make sure to provide correct information from
                Envato/codecanyon</small></h4>
            <hr />

            <div class="col-md-4">
              <div class="form-group">
                <label for="envato_purchase_code">Envato Purchase Code:*</label>
                <input type="password" name="ENVATO_PURCHASE_CODE" required class="form-control"
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="password" name="MAC_LICENCE_CODE" required class="form-control"
                  id="activation_licence_code">
              </div>
            </div>
            @endif
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="db_port" name="DB_PORT" required value="{{ old('DB_PORT', '3306') }}">
              </div>
            </div>
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="db_database" name="DB_DATABASE" required value="{{ old('DB_DATABASE') }}">
              </div>
            </div>
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="db_username" name="DB_USERNAME" required value="{{ old('DB_USERNAME') }}">
              </div>
            </div>

                  <div class="col-md-6">
                    <div class="form-group">
                        <label for="db_password">Database Password: <small>(optional)</small></label>
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="email" class="form-control" id="MAIL_FROM_ADDRESS" name="MAIL_FROM_ADDRESS"
                  ...
                  placeholder="hello@ultimatepos.com" required>
              </div>
            </div>
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="MAIL_FROM_NAME" name="MAIL_FROM_NAME"
                  ...
                  placeholder="Ultimate POS (Optional)">
              </div>
            </div>
            ...
            <div class="col-md-4 smtp hide">
              <div class="form-group">
                ...
                <input type="text" class="form-control smtp_input" id="MAIL_HOST" name="MAIL_HOST" required disabled value="{{ old('MAIL_HOST') }}">
              </div>
            </div>
            ...
            <div class="col-md-4  smtp hide">
              <div class="form-group">
                ...
                <input type="text" class="form-control smtp_input" id="MAIL_PORT" name="MAIL_PORT" required disabled value="{{ old('MAIL_PORT') }}">
              </div>
            </div>
            ...
            <div class="col-md-4  smtp hide">
              <div class="form-group">
                ...
                <input type="text" class="form-control smtp_input" id="MAIL_ENCRYPTION" name="MAIL_ENCRYPTION" required
                  value="{{ old('MAIL_ENCRYPTION') }}"
                  disabled placeholder="tls or ssl">
              </div>
            </div>
            ...
            <div class="col-md-6  smtp hide">
              <div class="form-group">
                ...
                <input type="text" class="form-control smtp_input" id="MAIL_USERNAME" name="MAIL_USERNAME" required
            ...
            <div class="col-md-6  smtp hide">
              <div class="form-group">
                ...
                <input type="password" class="form-control smtp_input" id="MAIL_PASSWORD" name="MAIL_PASSWORD" required
